...
use proxy\inventory\FurnaceRecipe;
use proxy\inventory\ShapedRecipe;
use proxy\inventory\ShapelessRecipe;
use proxy\item\enchantment\Enchantment;
use proxy\item\enchantment\EnchantmentList;
