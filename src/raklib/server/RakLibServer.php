...
class RakLibServer extends \Thread{
	 ...
	 * @throws \Throwable
	 */
	public function __construct(\ThreadedLogger $logger, \ClassLoader $loader, Proxy $proxy, Socket $socket, $port, $interface = "0.0.0.0"){
		$this->port = (int) $port;
	...
	public function run(){
		...
		$this->sessionManager = new \raklib\SessionManager($this, $this->proxy, $this->socket);
	}
